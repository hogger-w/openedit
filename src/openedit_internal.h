...
inline constexpr int kSearchMarkIndicator = 30;
inline constexpr DWORD kFindOptionRegex = 0x10000000;
inline constexpr DWORD kFindOptionFullDocument = 0x20000000;
inline constexpr DWORD kFindOptionMask = FR_DOWN | FR_MATCHCASE | FR_WHOLEWORD | kFindOptionRegex | kFindOptionFullDocument;
...
struct DocumentTab
{
    ...
    sptr_t xOffset = 0;
    std::wstring searchMarkText;
    DWORD searchMarkOptions = 0;
    bool hasSearchMarks = false;
    bool modified = false;
    bool untitled = true;
